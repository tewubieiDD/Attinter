...
from spd.base_module_newton_v1_1 import E2R, Submanifold, AttentionManifold
...
class ChaNewtonKDimNet(nn.Module, _SubmanifoldAttentionMixin):
    def __init__(self, slice, k_dims):
        super().__init__()
        self.slice = slice
        self.conv1 = nn.Conv2d(self.slice, 22 * self.slice, (56, 1), groups=self.slice)
        self.Bn1 = nn.BatchNorm2d(22 * self.slice)
