...
if __name__ == '__main__':
    ...
    auc = train_network_loss(net, trainloader, validloader, testloader, recorder, test_metric_type='auc', **args)
    recorder.save_summary(auc)
