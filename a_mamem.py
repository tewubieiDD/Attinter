...
if __name__ == '__main__':
    ...
    ap.add_argument('--dataset', type=str, default='SSVEP')
    ...
    ap.add_argument('--data_path', type=str, default='data/MAMEM/')
    ap.add_argument('--slice', type=int, default=7, help='number of epochs that you want to use for split EEG signals')
